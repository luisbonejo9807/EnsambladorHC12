...
public final class EnsambladorHC12Raw {
    ...
    private final String TEMPORAL_FILE_NAME = "/P9TMP.txt";    
    ...
    private String contenidoPasoDos;
    ...
    public void inicializarVariables(){
        ...
        {            
            ...
            {
                this.setContenidoPasoDos("El Contenido del archivo Temporal tiene errores terminando el programa");
                return;
            }
            this.setContenidoTabsim(Tabsim.procesarTabsim(this.getContenidoArchivoTemporalTxt()));
            this.setContenidoPasoDos(Practica9.procesarTemporal(this.getContenidoTABOPtxt(),this.getContenidoArchivoTemporalTxt()));
            this.setCodigoFinal(Practica10.procesarPasoDos(this.getContenidoPasoDos(), this.getASMTXT_FILE_NAME()));
            //Ensamblador a crear
    ...
    public String getContenidoDeArchivoASMProcesadotxt() {
        return this.contenidoDeArchivoASMProcesadotxt;
    }
   ...
   public void crearArchivosDeErrores(String FILE_CONTENT){
    ...
    /**
     * @return the contenidoPasoDos
     */
    public String getContenidoPasoDos() {
        return contenidoPasoDos;
    }

    /**
     * @param contenidoPasoDos the contenidoPasoDos to set
     */
    public void setContenidoPasoDos(String contenidoPasoDos) {
        this.contenidoPasoDos = contenidoPasoDos;
    }
    ...
    /**
     * @param codigoFinal the codigoFinal to set
     */
